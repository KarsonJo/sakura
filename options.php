...
function optionsframework_options()
{
    ...
    $options[] = array(
        'name' => __('Analytics Tracking Code', 'nova'), /*流量统计代码*/
        'desc' => __('html script snippet', 'nova'),
        'id' => 'analytics_code',
        'std' => '',
        'type' => 'textarea'
    );
    ...
    $options[] = array(
        'name' => __('Analytics API doamin', 'sakura'),
        'desc' => __('Analytics API doamin', 'sakura'),
        'id' => 'analytics_api_domain',
        'std' => '',
        'type' => 'text'
    );

    $options[] = array(
        'name' => __('Analytics API token', 'sakura'),
        'desc' => __('Analytics API token', 'sakura'),
        'id' => 'analytics_api_token',
        'std' => '',
        'type' => 'text'
    );

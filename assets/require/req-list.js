...
define("loadCSS", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.loadCSS;
    };
}(this)));
...
define("require/req-list", function(){});

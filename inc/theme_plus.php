...
{ ?>
  ...
  <?php if (current_user_can('level_10')) { ?>
    <div class="admin-login-check">
      <?php echo login_ok(); ?>
      <?php if (akina_option('login_urlskip')) { ?><script>
          window.open("<?php bloginfo('url'); ?>/wp-admin/", 1);
...
/**
 * karson_todo_util
 * get first attachment image of current post
 * @param string|int[] $size
 * Image size. Accepts any registered image size name, or an array of width and height values in pixels
 * @return array|false
  ...
  if (!is_home() && $full_image_url) : ?>
    <div class="pattern-center <?php if (is_single()) {
      ...
      <div class="pattern-attachment-img" style="height: auto;">
        <video loop id="coverVideo" class='hls' style="width: 100%; height: 100%" <?php echo $video_poster_attr; ?> data-src="<?php echo $video_cover; ?>">
